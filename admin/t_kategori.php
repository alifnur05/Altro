        ...
        <li class="nav-item dropdown pe-3">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            <li class="dropdown-header">
              <h6><?php echo isset($_SESSION['username']) ? htmlspecialchars($_SESSION['username']) : 'Guest';?></h6><h6>Alif</h6>
              <span>Admin</span>
            </li>
            <li>
            ...
            <div class="card-body">
              <form class="row g-3 mt-2" method="post">
                <div class="col-12">
                  ...
                  <input type="text" class="form-control" id="nm_kategori" placeholder="Masukkan Nama Kategori Produk" name="nm_kategori">
                </div>
